  ...
  return (
    <section id="contact" className="py-24 bg-light-bg">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Top Row: Map (Left) + Contact Info (Right) */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
          ...
          <motion.div
            ...
            className="rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.08)] min-h-[380px]"
          >
            <iframe
        ...
        {/* Bottom Center – Inquiry Form */}
        <motion.div
          ref={formRef}
          initial={{ opacity: 0, y: 30 }}
          animate={formInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.6, delay: 0.3 }}
          className="max-w-3xl mx-auto bg-white p-8 md:p-10 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.08)]"
        >
          <h3 className="font-serif text-2xl font-semibold text-dark mb-2 text-center">
            Send an Inquiry
          </h3>
          <p className="text-sm text-muted mb-7 font-light text-center">
