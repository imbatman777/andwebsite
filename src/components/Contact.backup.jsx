  ...
  return (
    <section id="contact" className="py-20 bg-light-bg">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Main Row: Map (Left) + Inquiry Form (Right) */}
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-8 mb-8">
          ...
          >
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.563961129532!2d55.2855686!3d25.2516074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43139fc03a61%3A0xdc0ad8a0819c597f!2sAND%20Events%20Management%20LLC.!5e0!3m2!1sen!2sae!4v1700000000000!5m2!1sen!2sae"
              width="100%"
              height="100%"
          ...
          >
            ...
            <p className="text-sm text-muted mb-6 font-light text-center">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-[0.95rem] text-dark bg-light-bg border-[1.5px] border-transparent rounded-lg outline-none transition-all duration-300 focus:border-primary focus:bg-white focus:shadow-[0_0_0_3px_rgba(160,0,0,0.08)] placeholder:text-light-text placeholder:font-light"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 text-[0.95rem] text-dark bg-light-bg border-[1.5px] border-transparent rounded-lg outline-none transition-all duration-300 focus:border-primary focus:bg-white focus:shadow-[0_0_0_3px_rgba(160,0,0,0.08)] placeholder:text-light-text placeholder:font-light resize-y min-h-[90px]"
                />
              </div>
              ...
              <button
                ...
                className={`w-full py-3.5 text-white text-base font-semibold rounded-lg flex items-center justify-center gap-2 transition-all duration-300 cursor-pointer ${
                  formState === 'sent'
                    ? 'bg-green-600'
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          {/* Email */}
          <motion.a
            href="mailto:admin@andevents.org"
            initial={{ opacity: 0, y: 20 }}
            animate={headerInView ? { opacity: 1, y: 0 } : {}}
          ...
          {/* Address */}
          <motion.a
            href="https://maps.app.goo.gl/Kcvoats8mX3oq22M7"
            target="_blank"
            rel="noopener noreferrer"
            initial={{ opacity: 0, y: 20 }}
            animate={headerInView ? { opacity: 1, y: 0 } : {}}
